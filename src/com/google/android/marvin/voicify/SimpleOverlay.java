...
public class SimpleOverlay {
    ...
    /**
     * Sets the top-level touch listener.
     * 
     * @param listener The touch listener to set.
     */
    ...
    /**
     * Sets the top-level hover listener.
     * 
     * @param listener The hover listener to set.
     */
    public void setOnHoverListener(View.OnHoverListener listener) {
        mContentView.setOnHoverListener(listener);
    }
